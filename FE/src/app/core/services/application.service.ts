...
export class ApplicationService {
  ...
  getApplicationsByPosting(postingId: string): Observable<ApplicationResponse[]> {
    return this.http
      .get<any>(`${this.apiUrl}/posting/${postingId}`)
  ...
  getPipeline(postingId: string): Observable<PipelineResponse[]> {
    return this.http.get<PipelineResponse[]>(
      `${environment.apiUrl}/postings/${postingId}/pipeline`,
    );
  }
  ...
  updateApplicationStage(
    ...
    return this.http.patch<ApplicationResponse>(`${this.apiUrl}/${applicationId}/stage`, { stage });
  }
