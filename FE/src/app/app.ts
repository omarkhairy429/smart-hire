...
@Component({
  ...
  imports: [RouterOutlet, RouterLink, CommonModule, ErrorToastComponent],
...
export class AppComponent implements OnInit, OnDestroy {
  ...
  startNotificationPolling(): void {
    ...
    this.notificationPolling = this.notificationService.startPolling().subscribe((count) => {
  ...
  openNotification(notification: Notification): void {
    ...
    switch (notification.type) {
      ...
      case NotificationType.INTERVIEW_SCHEDULED:
        if (this.userRole === 'INTERVIEWER' && notification.relatedEntityId) {
          this.router.navigate(['/interviewer/interviews', notification.relatedEntityId]);
